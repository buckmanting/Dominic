...
namespace Dominic.Test
{
    public class GetAllTests
    {
        ...
        {
            var sut = await Template.Render("TestView/MultipleDuplicateIds.cshtml", new {TestText = "Hello World"});
        ...
        {
            var sut = await Template.Render("TestView/MultipleUniqueIds.cshtml", new {TestText = "Hello World"});
